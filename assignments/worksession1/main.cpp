...
void drawThing(ew::Shader& _shader, ew::Mesh& _plane, GLuint& _texture1)
{
	...
	_shader.setFloat("_B1", debug.b1);
	_shader.setFloat("_B2", debug.b2);
...
int main() {
	...
	GLuint waterTexture = ew::loadTexture("assets/Archive/windwaker/water.png");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		//RENDER
		drawThing(waterShader, plane, waterTexture);
...
void drawUI() {
	...
	ImGui::ColorEdit3("Reflect Color", &debug.reflectColor[0]);
	ImGui::DragFloat2("Water Direction", &debug.direction[0]);
	ImGui::SliderFloat("Blend1", &debug.b1, 0.0f, 1.0f);
	ImGui::SliderFloat("Blend2", &debug.b2, 0.0f, 1.0f);
	ImGui::SliderFloat("Tiling", &debug.tiling, 0.0f, 10.0f);
	ImGui::SliderFloat("Strength", &debug.strength, 0.0f, 10.0f);
